	...
	<div>
		<transition name="lightbox-fade">
			<div class="lightbox" v-if="visible" @mousedown.stop="hide" @touchdown.stop="hide">
				...
				<div
						class="lightbox-arrow lightbox-arrow-left" @mousedown.stop.prevent="prev"
				...
				<div
						class="lightbox-arrow lightbox-arrow-right" @mousedown.stop.prevent="next"
				...
				<transition name="lightbox-fade">
					<div
							class="lightbox-caption" v-show="controlsVisible && filteredImages[index].alt"
							@mousedown.stop @touchdown.stop>
				...
				<div class="lightbox-main" @mousedown.stop="hide" @touchdown.stop="hide">
					<div class="lightbox-image-container" @mousedown.stop @touchdown.stop>
						<transition :name="slideTransitionName" mode="out-in">
							<div
									class="lightbox-image" :key="index"
